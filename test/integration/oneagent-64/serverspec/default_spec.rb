...
opts = { DT_AGENT_BASE_URL: DT_AGENT_BASE_URL, DT_API_TOKEN: 'w89AycHAQByUUfu993UHG' }
describe command(parse_cmd('~/paas-install.sh', opts)) do
...
opts = { DT_AGENT_BASE_URL: DT_AGENT_BASE_URL, DT_API_TOKEN: DT_API_TOKEN, DT_AGENT_BITNESS: 'all', DT_AGENT_PREFIX_DIR: '/tmp' }
describe command(parse_cmd('~/paas-install.sh', opts)) do
